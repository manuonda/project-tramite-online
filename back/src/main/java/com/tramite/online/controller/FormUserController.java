...
//https://blogger.jetbrains.com/idea/2025/02/database-migrations-in-the-real-world/
...
public class FormUserController {
    ...
    public ResponseEntity<FormUserDTO>  createFormUser(@Valid @RequestBody FormUserDTO formUserDTO){ 
        logger.info("Create form user dto {}", formUserDTO);
    ...
    @RequestBody FormUserDTO dto){
       logger.info("Update User by Id : {} {}", id, dto);
